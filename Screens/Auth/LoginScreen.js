...
import { StyleSheet, View, Text, TextInput, Image, ScrollView, TouchableHighlight,Alert,TouchableOpacity } from 'react-native';
       ...
       return (
           <View style={styles.MainContainer}>
               <ScrollView>
                   ...
                   <TouchableOpacity style={[styles.buttonContainer, styles.captureButton]}
                   onPress={Alert.alert('test')} >
                       <Text style={styles.buttonText}>Capture Image</Text>
                   </TouchableOpacity>

                   <TouchableOpacity style={[styles.buttonContainer, styles.submitButton]}    >
